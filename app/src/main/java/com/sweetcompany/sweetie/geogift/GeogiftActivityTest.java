...
public class GeogiftActivityTest extends AppCompatActivity {

    private static final String TAG = "GeogiftActivityTest";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mView = (GeogiftFragmentTest) getSupportFragmentManager()
                .findFragmentById(R.id.geogift_fragment_container_test);

        if (mView == null) {
            mView = GeogiftFragmentTest.newInstance(getIntent().getExtras());
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();

            transaction.add(R.id.geogift_fragment_container_test, (GeogiftFragmentTest)mView);
            transaction.commit();
        }
